                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                            <li><a href="vendors-list.php" class="active">Vendors</a></li>
                                            <li><a href="vendor-dashboard.php"> Dashboard</a></li>
                                            <li><a href="vendor-guide.html"> Guide</a></li>
                                        </ul>
                                    </li>
                                    <li class="position-static">
                                        <a href="#" class="active">Mega menu <i class="fi-rs-angle-down"></i></a>
                                        <ul class="mega-menu">
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                            ...
                            <ul class="contact-infor">
                                ...
                                <li><img src="assets/imgs/theme/icons/icon-email-2.svg" alt="" /><strong>Email:</strong><span><a href="http://wp.alithemes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="84f7e5e8e1c4cae1f7f0aae7ebe9">[email&#160;protected]</a></span></li>
