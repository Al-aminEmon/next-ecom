                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <h3 class="title-detail"><a href="shop-product-right.php" class="text-heading">Seeds of
                            ...
                            <div class="header-action-2">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="shop-product-right.php"><img alt="Nest"
                                ...
                                <div class="header-action-icon-2">
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>
                                            <li>
                                                <a href="page-account.php"><i class="fi fi-rs-user mr-10"></i>My
                                                    Account</a>
                                            </li>
                                            <li>
                                                <a href="page-account.php"><i
                                                        class="fi fi-rs-location-alt mr-10"></i>Order Tracking</a>
                                            </li>
                                            <li>
                                                <a href="page-account.php"><i class="fi fi-rs-label mr-10"></i>My
                                                    Voucher</a>
                                            </li>
                                            <li>
                                                <a href="shop-wishlist.php"><i class="fi fi-rs-heart mr-10"></i>My
                                                    Wishlist</a>
                                            </li>
                                            <li>
                                                <a href="page-account.php"><i
                        ...
                        <div class="main-categori-wrap d-none d-lg-block">
                            ...
                            <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li>
                                            <a href="shop-grid-right.php"> <img
                            ...
                            <nav>
                                <ul>
                                    <li class="hot-deals"><img src="assets/imgs/theme/icons/icon-hot.svg"
                                            alt="hot deals" /><a href="shop-grid-right.php" class="active">Deals</a></li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li><a href="vendor-guide.php"> Guide</a></li>
                                        </ul>
                                    </li>
                                        ...
                                        <ul class="mega-menu">
                                            <li class="sub-mega-menu sub-mega-menu-width-22">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="shop-product-right.php">Exotic Fruits & Veggies</a>
                                                    </li>
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="shop-product-right.php"><img
            ...
            <div class="row">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="shop-product-right.php">All Natural Italian-Style Chicken
                                            Meatballs</a></h2>
                                    <div class="product-rate-cover">
                                        <div class="product-rate d-inline-block">
                                ...
                                <div class="product-cart-wrap style-2">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="deals-content">
                                            <h2><a href="shop-product-right.php">Seeds of Change Organic Quinoa,
                                                    Brown</a></h2>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 90%"></div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="product-cart-wrap style-2">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="deals-content">
                                            <h2><a href="shop-product-right.php">Perdue Simply Smart Organics
                                                    Gluten</a></h2>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 90%"></div>
                                            ...
                                            <div>
                                                <span class="font-small text-muted">By <a
                                                        href="vendor-details-1.php">Old El Paso</a></span>
                                            </div>
                                            <div class="product-card-bottom">
                                                <div class="product-price">
                                                    <span>$24.85</span>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 d-none d-xl-block">
                                <div class="product-cart-wrap style-2">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="deals-content">
                                            <h2><a href="shop-product-right.php">Simply Lemonade with Raspberry
                                                    Juice</a></h2>
                                            <div class="product-rate-cover">
                                                <div class="product-rate d-inline-block">
                                                    <div class="product-rating" style="width: 80%"></div>
                ...
                <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                    <div class="sidebar-widget widget-category-2 mb-30">
                        ...
                        <ul>
                            <li>
                                <a href="shop-grid-right.php"> <img src="assets/imgs/theme/icons/category-1.svg"
                                        alt="" />Milks & Dairies</a><span class="count">30</span>
                            </li>
                            <li>
                                <a href="shop-grid-right.php"> <img src="assets/imgs/theme/icons/category-2.svg"
                                        alt="" />Clothing</a><span class="count">35</span>
                            </li>
                            <li>
                                <a href="shop-grid-right.php"> <img src="assets/imgs/theme/icons/category-3.svg"
                                        alt="" />Pet Foods </a><span class="count">42</span>
                            </li>
                            <li>
                                <a href="shop-grid-right.php"> <img src="assets/imgs/theme/icons/category-4.svg"
                                        alt="" />Baking material</a><span class="count">68</span>
                            </li>
                            <li>
                                <a href="shop-grid-right.php"> <img src="assets/imgs/theme/icons/category-5.svg"
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                            <div class="logo mb-30">
                                <a href="index.php" class="mb-15"><img src="assets/imgs/theme/logo.svg"
                                        alt="logo" /></a>
                            ...
                            <ul class="contact-infor">
                                ...
                                <li><img src="assets/imgs/theme/icons/icon-email-2.svg"
                                        alt="" /><strong>Email:</strong><span><a
                                            ...
                                            class="__cf_email__"
                                            data-cfemail="790a18151c39371c0a0d571a1614">[email&#160;protected]</a></span>
                                </li>
